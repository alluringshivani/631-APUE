...
int main(int argc, char *argv[])
{
	...
	{ /*checking if the source file and destination file are the same while copy command is being used*/
	...
	{ /*IS_DIR is a function that checks if the file is a directory or not*/
	...
	{ /*copying character by character to the destination file until we reach EOF*/
		fputc(c, file2);
	}
